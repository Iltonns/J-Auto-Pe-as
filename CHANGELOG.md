...
## Versão 2.1.1 - Correção: Busca Universal

**Data:** 29 de Outubro de 2025  
**Status:** ✅ Corrigido e testado

### 🔧 Correção Aplicada
Busca inteligente agora funciona **em todas as páginas**:
- ✅ **Produtos** - Corrigido ID do campo
- ✅ **Orçamentos** - Desabilitadas funções antigas conflitantes
- ✅ **Vendas** - Já funcionava corretamente

### Arquivos Modificados:
- `static/js/pagination.js` - Busca inteligente implementada
- `templates/produtos.html` - ID corrigido (searchInput → buscaProdutos)
- `templates/orcamentos.html` - Funções antigas desabilitadas

📄 **Documentação**: `CORRECAO_BUSCA_UNIVERSAL.md`

---

## Versão 2.1.0 - Busca Inteligente de Produtos
...
Sistema de busca com suporte a **múltiplos termos**, permitindo buscas mais precisas e eficientes.

#### Como Usar:
- **Busca com %**: `PIVO%GOL` encontra todos os produtos que contenham "PIVO" E "GOL"
- **Busca com espaço**: `AMORTECEDOR DIANTEIRO` encontra produtos com ambos os termos
- **3+ termos**: `FILTRO%OLEO%1.0` encontra filtros de óleo para motor 1.0

#### Características:
- ✅ Case-insensitive (não diferencia maiúsculas/minúsculas)
- ✅ Busca em: nome, marca, categoria, código barras, código fornecedor
- ✅ Todos os termos devem estar presentes (lógica AND)
- ✅ Ordenação por relevância
- ✅ Até 50 resultados para performance otimizada

#### Onde Está Disponível:
- ✅ **Produtos** - Lista de produtos
- ✅ **Vendas** - Busca de produtos para venda
- ✅ **Orçamentos** - Busca de produtos para orçamento

#### Arquivos Modificados:
- `Minha_autopecas_web/logica_banco.py` - Função `buscar_produto()`
- `app.py` - API `/api/produtos/buscar`
- `templates/produtos.html` - Campo de busca atualizado
- `templates/vendas.html` - Campo de busca atualizado
- `templates/orcamentos.html` - Campo de busca e função JS atualizada

#### Documentação:
- 📄 `BUSCA_INTELIGENTE.md` - Guia completo de uso
- 📄 `CHANGELOG_BUSCA_INTELIGENTE.md` - Detalhes técnicos
- 🧪 `test_busca_inteligente.py` - Script de testes
